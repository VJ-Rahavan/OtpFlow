                ...
                <View style={styles.form}>
                    ...
                    <View
                        ...
                        <TouchableOpacity style={styles.formButton} onPress={() => navigation.navigate(NavigationConstants.HOME)}>
                            <Text style={styles.formButtonText}>Lets Go</Text>
                        </TouchableOpacity>
                    </View>

                    <View
                        style={styles.formFooter}>
                        <Text>ahh new to Otp flow ?</Text>
                        <TouchableOpacity onPress={() => navigation.navigate(NavigationConstants.SIGNUP)}>
                            <Text style={styles.formFooterSingup} >Sign-Up</Text>
                        </TouchableOpacity>
                    </View>
